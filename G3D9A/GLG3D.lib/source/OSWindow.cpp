...
#if defined(G3D_ANDROID)
#    include "GLG3D/AndroidWindow.h"
...
#   if defined(G3D_ANDROID)
        return AndroidWindow::primaryDisplaySize();
#   elif defined(G3D_WIN32)
...
#   if defined(G3D_ANDROID)
        return AndroidWindow::virtualDisplaySize();
#   elif defined(G3D_WIN32)
...
#   if defined(G3D_ANDROID)
        return AndroidWindow::primaryDisplayWindowSize();
#   elif defined(G3D_WIN32)
...
#   if defined(G3D_ANDROID)
        return AndroidWindow::numDisplays();
#   elif defined(G3D_WIN32)
...
#   if defined(G3D_ANDROID)
        /* We do not allow clients to create Android windows. */
        return NULL;
#   elif defined(G3D_WIN32)
