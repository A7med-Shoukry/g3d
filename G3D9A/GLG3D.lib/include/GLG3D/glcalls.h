...
inline void glVertex(const G3D::Vector2& v) {
	glVertexPointer(2, GL_FLOAT, 0, (const float*)&v);
}


inline void glVertex(const G3D::Vector2int16& v) {
	glVertexPointer(2, GL_SHORT, 0, (const short *)&v);
}


inline void glVertex(const G3D::Vector3& v) {
	glVertexPointer(3, GL_FLOAT, 0, (const float*)&v);
}


inline void glVertex(const G3D::Vector3int16& v) {
	glVertexPointer(3, GL_SHORT, 0, (const short *)&v);
}


inline void glVertex(const G3D::Vector4& v) {
	glVertexPointer(4, GL_FLOAT, 0, (const float*)&v);
}


inline void glColor(const G3D::Color3 &c) {
	glColorPointer(3, GL_FLOAT, 0, (const float*)&c);
}


inline void glColor(const G3D::Color4& c) {
	glColorPointer(4, GL_FLOAT, 0, (const float*)&c);
}
...
inline void glNormal(const G3D::Vector3& n) {
	glNormalPointer(GL_FLOAT, 0, (const float*)&n);
}


inline void glTexCoord(const G3D::Vector4& t) {
	glTexCoordPointer(4, GL_FLOAT, 0, (const float*)&t);
}


inline void glTexCoord(const G3D::Vector3& t) {
	glTexCoordPointer(3, GL_FLOAT, 0, (const float*)&t);
}


inline void glTexCoord(const G3D::Vector2& t) {
	glTexCoordPointer(2, GL_FLOAT, 0, (const float*)&t);
}


inline void glTexCoord(const float t) {
	glTexCoordPointer(1, GL_FLOAT, 0, (const float*)&t);
}
