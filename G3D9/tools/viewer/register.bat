...
echo MD3, ANY, FNT, and GTM files with the %bits%-bit G3D viewer in
echo %CD%?
echo. 
SET /P result="[Y/N] "
...
reg add "HKEY_CURRENT_USER\Software\Classes\3D Model\shell\open\command" /ve /d %viewer% /f

reg add HKEY_CURRENT_USER\Software\Classes\.fnt /ve /d "G3D Font" /f
reg add "HKEY_CURRENT_USER\Software\Classes\G3D Font\shell\open\command" /ve /d %viewer% /f

reg add HKEY_CURRENT_USER\Software\Classes\.gtm /ve /d "G3D GUI Theme" /f
reg add "HKEY_CURRENT_USER\Software\Classes\G3D GUI Theme\shell\open\command" /ve /d %viewer% /f

reg add HKEY_CURRENT_USER\Software\Classes\.any /ve /d "G3D Data File" /f
reg add "HKEY_CURRENT_USER\Software\Classes\G3D Data File\shell\open\command" /ve /d %viewer% /f
