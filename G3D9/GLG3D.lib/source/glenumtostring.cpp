...
const char* GLenumToString(GLenum i) {
    ...
    S(GL_SAMPLER_1D_ARB);
    S(GL_INT_SAMPLER_1D_EXT);
    S(GL_UNSIGNED_INT_SAMPLER_1D_EXT);
    S(GL_SAMPLER_2D_ARB);
    S(GL_INT_SAMPLER_2D_EXT);
    S(GL_UNSIGNED_INT_SAMPLER_2D_EXT);
    S(GL_SAMPLER_3D_ARB);
    S(GL_INT_SAMPLER_3D_EXT);
    S(GL_UNSIGNED_INT_SAMPLER_3D_EXT);
    S(GL_SAMPLER_CUBE_ARB);
    S(GL_INT_SAMPLER_CUBE_EXT);
    S(GL_UNSIGNED_INT_SAMPLER_CUBE_EXT);
